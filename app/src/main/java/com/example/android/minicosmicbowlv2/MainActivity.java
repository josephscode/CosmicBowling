package com.example.android.minicosmicbowlv2;
...
public class MainActivity extends Activity {
  ...
  int currentPlayer;
  int nextPlayer;
  int player1CurrentFrame;
  int player2CurrentFrame;
  int player1CurrentRoll;
  int player2CurrentRoll;
  int player1NextFrame;
  int player2NextFrame;
  int player1NextRoll;
  int player2NextRoll;
  Boolean player1BonusAllowed;
  Boolean player2BonusAllowed;
  String gameStatus = "Not started";
  Boolean player1Frame1Strike;
  Boolean player1Frame2Strike;
  Boolean player1Frame1Spare;
  Boolean player1Frame2Spare;
  Boolean player2Frame1Strike;
  Boolean player2Frame2Strike;
  Boolean player2Frame1Spare;
  Boolean player2Frame2Spare;
  String player1Frame1Result;
  String player1Frame2Result;
  String player2Frame1Result;
  String player2Frame2Result;
  int idxPlayer1Frame1Strike;
  int idxPlayer1Frame2Strike;
  int idxPlayer1Frame1Spare;
  int idxPlayer1Frame2Spare;
  int idxPlayer2Frame1Strike;
  int idxPlayer2Frame2Strike;
  int idxPlayer2Frame1Spare;
  int idxPlayer2Frame2Spare;
  int idxPlayer1Frame1;
  int idxPlayer1Frame2;
  int idxPlayer2Frame1;
  int idxPlayer2Frame2;
  TextView tv;
  EditText et;
  Button b;
  ...
  */
  ...
  public void setFrameScore(int player, int frame, int score) {
    ...
    if (score == 0) {
      ...
      scoreView.setText(String.valueOf(scorePlayer));
    }
  ...
  public void setPlayerScoreDisplay(int player, int score) {
    ...
    String player1TextViewId;
    String player2TextViewId;
    int player1ResourceId;
    int player2ResourceId;
    TextView player1ScoreView;
    TextView player2ScoreView;
    String player1ScoreValue;
    String player2ScoreValue;
  ...
  public void incrementPlayerFrameRoll(String score) {
    ...
    if(currentPlayer == 2 && player2CurrentFrame == 3 && player2CurrentRoll == 2 && !player2BonusAllowed){
      gameStatus = "Finished";
      endGame();
      return;
    }
    ...
    if(nextPlayer == 1){
      setStatusText(getPlayerName(nextPlayer) + "'s turn. Roll #" + player1NextRoll);
    }
    else{
      setStatusText(getPlayerName(nextPlayer) + "'s turn. Roll #" + player2NextRoll);
    }
    refreshRollButtons();
  }
